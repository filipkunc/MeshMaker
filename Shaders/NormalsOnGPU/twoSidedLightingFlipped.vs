// twoSidedLightingFlipped.vs, same as twoSidedLighting.vs, gl_FrontColor and gl_BackColor is flipped
...
{	
	...
	gl_FrontColor = gl_Color * BackNdotL + vec4(0.25, 0.25, 0.25, 1.0);
	
	gl_BackColor = vec4(0.5, 0.5, 0.5, 1.0) * NdotL + vec4(0.2, 0.2, 0.2, 1.0);
